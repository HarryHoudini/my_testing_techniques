...
@Getter
public class FolderExistenceData extends SensorData {
    private final Optional<String> caption;
    private final Optional<String> path;

    public FolderExistenceData(Builder builder){
    ...
    public boolean equals(Object o) {
        ...
        FolderExistenceData expectedData = (FolderExistenceData) o;
